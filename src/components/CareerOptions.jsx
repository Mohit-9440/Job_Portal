...
const CategoryCard = ({ category, isFeatured = false }) => {
  return (
    <div
      className={`rounded-lg p-6 transition-all duration-300 hover:shadow-lg cursor-pointer ${
        isFeatured
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-purple-800 mb-2">
            ...
            <span className="text-gray-800 ml-2">Are Waiting</span>
          </h2>
          <p className="text-xl font-bold text-gray-800">For You to Explore</p>
        </div>
