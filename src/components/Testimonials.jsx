  ...
  const testimonials = [
    {
      ...
      name: "Sarah Johnson",
      role: "UX Designer",
      image: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=988&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      testimonial: "The job portal helped me find my dream role in UX design. The platform is incredibly user-friendly and the job recommendations were spot-on."
    },
    {
      id: 2,
      name: "Michael Chen",
      ...
      testimonial: "I was struggling to find the right product management position. This platform connected me with amazing opportunities I never knew existed."
    },
    {
      id: 3,
    ...
    },
    {
      ...
      testimonial: "The career counseling feature was invaluable. It helped me understand my strengths and find the perfect marketing role that matches my skills."
    },
    {
      id: 5,
      name: "David Kim",
      ...
      testimonial: "As a data scientist, I needed a platform that understood technical roles. This portal exceeded my expectations with relevant job matches."
    }
  ];
