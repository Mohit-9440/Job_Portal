      ...
      <div className="flex flex-row items-center justify-center">
        ...
        <div className="flex items-start justify-center mb-4 mr-4">
          <div className="relative">
            <span className="text-6xl font-bold text-muted-foreground flex items-center justify-center">
              {number}
            </span>
  ...
  const services = [
    {
      ...
      imageSrc: "https://images.unsplash.com/photo-1497366216548-37526070297c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
    ...
    },
    {
      ...
      description: "Build your professional profile and showcase your skills to potential employers.",
      imageSrc: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
    ...
    },
    {
      ...
      description: "Get expert career advice and guidance from industry professionals.",
